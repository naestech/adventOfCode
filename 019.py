def count_ways(design, patterns, memo=None):
    ...
    # Base case: empty design can be made in exactly one way
    if not design:
        return 1
    ...
    # Count ways using each pattern as a potential start
    total_ways = 0
